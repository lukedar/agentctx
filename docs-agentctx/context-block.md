...
<div class="docs-grid">
  <div class="docs-card docs-span-4"><h3>security rules</h3><p>Auth boundaries, secret handling, permission defaults, and sensitive paths.</p></div>
  ...
  <div class="docs-card docs-span-4"><h3>testing expectations</h3><p>Relevant test suites, validation commands, fixtures, and quality gates.</p></div>
</div>
